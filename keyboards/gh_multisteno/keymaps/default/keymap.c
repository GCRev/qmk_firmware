...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_SYM] = LAYOUT(
        _______, _______, KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS, _______, _______, KC_LPRN, KC_RPRN, _______, _______,
        KC_TAB,  _______, KC_P7,   KC_P8,   KC_P9,   KC_PPLS, _______, KC_UNDS, KC_LCBR, KC_RCBR, KC_EQL,  _______,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    case _FUN:
        // yellow 
        pwmEnableChannel(&PWMD2, 1, PWM_PERCENTAGE_TO_WIDTH(&PWMD2, 3500));
        pwmEnableChannel(&PWMD2, 2, PWM_PERCENTAGE_TO_WIDTH(&PWMD2, 1500));
    ...
    case _SYM:
        ...
        pwmEnableChannel(&PWMD2, 2, PWM_PERCENTAGE_TO_WIDTH(&PWMD2, 1500));
        pwmEnableChannel(&PWMD2, 0, PWM_PERCENTAGE_TO_WIDTH(&PWMD2, 3500));
        break;
    default:
        default_led();
        break;
