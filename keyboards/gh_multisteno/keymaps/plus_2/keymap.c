...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * └───┴───┼───┼───┼───┼───┼───┼───┼───┼───┼───┴───┘
     *         │ALT│SYM│FUN│SFT│SPC│SYM│WIN│FUN│
     *         └───┴───┴───┴───┴───┴───┴───┴───┘
     */
    [_BASE] = LAYOUT(
        ...
        TO_STN,     KC_Z,    KC_X,     KC_C,     KC_V,     KC_B,    KC_N,   KC_M,     KC_COMM,  KC_DOT, KC_SLSH, KC_ENT,
                             KC_LALT,  MO(_SYM), MO_FUN,   KC_LSFT, KC_SPC, MO(_SYM), MO(_FUN), KC_LWIN
    ),
    ...
    [_STENO] = LAYOUT(
        ...
        XXXXXXX,   PLV_S1,  PLV_TL,  PLV_PL,  PLV_HL,  PLV_ST1, PLV_ST3, PLV_FR,  PLV_PR,  PLV_LR,  PLV_TR,  PLV_DR,
        XXXXXXX,   PLV_S2,  PLV_KL,  PLV_WL,  PLV_RL,  PLV_ST2, PLV_ST4, PLV_RR,  PLV_BR,  PLV_GR,  PLV_SR,  PLV_ZR,
        TO(_BASE), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                            PLV_X1 , PLV_N1,  PLV_A,   PLV_O,   PLV_E,   PLV_U,   PLV_N2,  PLV_X2 
    ),
    ...
    [_SYM] = LAYOUT(
        ...
        KC_GRV,  _______, KC_P7,   KC_P8,   KC_P9,   KC_PPLS, _______, KC_UNDS, KC_LBRC, KC_RBRC, KC_EQL,  _______,
        _______, _______, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, _______, KC_MINS, KC_LCBR, KC_RCBR, KC_PLUS, _______,
        KC_PDOT, KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, _______, KC_LT,   KC_GT,   _______, _______,
                          _______, _______, _______, _______, _______, _______, _______, _______
    )
};
